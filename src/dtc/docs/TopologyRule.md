...
**source** | **str** | Type of source.  Allowed values: - subnet - tag_rule - topology - default  Defaults to _default_. | [optional] 
...
**topology_id** | **str** | The resource identifier. | [optional] 
